...
export function Select() {
  return (
    <SelectPrimitive.Root>
      <SelectPrimitive.Trigger className="flex h-11 w-full items-center justify-between gap-2 rounded-lg border border-b-zinc-300 px-3 py-2 shadow-sm data-[placeholder]:text-zinc-600">
